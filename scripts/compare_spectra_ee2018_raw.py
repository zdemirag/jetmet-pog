...
def main():
    ...
    t_in.Draw(args.var+">>h4","rawjet_pt>40","goff")
    t_in.Draw(args.var+">>h3","rawjet_pt>30","goff")
    t_in.Draw(args.var+">>h2","rawjet_pt>20","goff")
    t_in.Draw(args.var+">>h1","rawjet_pt>10","goff")
