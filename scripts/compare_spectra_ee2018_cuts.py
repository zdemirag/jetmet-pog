...
def main():
    ...
    t_in.Draw(args.var+">>h4","jet_pt>40 && abs(jet_eta)>2.5 && abs(jet_eta)<3.0","goff")
    t_in.Draw(args.var+">>h3","jet_pt>30 && abs(jet_eta)>2.5 && abs(jet_eta)<3.0","goff")
    t_in.Draw(args.var+">>h2","jet_pt>20 && abs(jet_eta)>2.5 && abs(jet_eta)<3.0","goff")
    t_in.Draw(args.var+">>h1","jet_pt>10 && abs(jet_eta)>2.5 && abs(jet_eta)<3.0","goff")
    ...
    tex= TLatex(0.12, 0.95,args.output+" 2.5 < |#eta| < 3.0");
